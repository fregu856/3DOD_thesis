...
################################################################################
# KITTI WITH 2D CONFIDENCE SCORES AS CONFIDENCE SCORES:
################################################################################
import pickle
import numpy as np
import os
...
# NOTE NOTE! NOTE! NOTE! NOTE! NOTE! change this for every new experiment
experiment_name = "model_da_img_only_val_2ddetections_conf"
...
# NOTE! NOTE! NOTE! NOTE! NOTE! NOTE! NOTE! NOTE! NOTE! NOTE! NOTE! NOTE! NOTE!
with open("/home/fregu856/eval_dict_val_2ddetections_imgnet.pkl", "rb") as file:
#with open("/home/fregu856/exjobb/training_logs/da/naive/eval_dict.pkl", "rb") as file:
    eval_dict = pickle.load(file)
